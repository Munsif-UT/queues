                ...
                <tr> 
                 <td align="center" valign="top" style="padding:0;Margin:0;width:660px"> 
                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                    ...
                    <tr> 
                     <td align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:43px;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;font-size:36px;font-style:normal;font-weight:normal;color:#333333">Contact Form</h2></td> 
                    </tr> 
                    <tr> 
                    ...
                    <tr> 
                     <td  class="es-m-p0r" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px;text-align:left">
                    <h2>Profile Details :</h2><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Name:</span>${pName} </p><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Email:</span>${pEmail} </p><br>
                    
                    <h2>Form Details :</h2><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Name:</span>${name} </p><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Email:</span>${email} </p><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Subject:</span>${subject} </p><br>
                    <p style="margin:0;padding:0;"><span style="width:80px; display: inline-block; margin-right:70px; font-weight:bold">Message:</span>${message} </p><br>
                    </tr> 
                  </table></td> 
                </tr> 
              </table></td> 
